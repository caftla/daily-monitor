  ...
  return <TABLE width={930}>
    ...
    <tbody>{
      data.data.map((x, i) => <tr key={i}>
        <TD width={60}  value={x.country_code} link={ `https://sam-dash.herokuapp.com/filter_page_section_row/${date_from}/${date_to}/country_code=${x.country_code}/country_code/country_code/day?username=sam-media&hash=37b90bce2765c2072c` } style={{ paddingLeft: '0.7em' }}  />
        <TD width={150} value={x.affiliate_name} link={ `https://sam-dash.herokuapp.com/filter_page_section_row/${date_from}/${date_to}/country_code=${x.country_code},affiliate_name=${x.affiliate_name}/country_code/affiliate_id/day?username=sam-media&hash=37b90bce2765c2072c` } />
